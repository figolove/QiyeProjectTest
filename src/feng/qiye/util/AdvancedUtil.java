...
import feng.qiye.pojo.resp.Music;
public class AdvancedUtil {
	private static Logger log = LoggerFactory.getLogger(AdvancedUtil.class);
	
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = QiYeUtil.getAccessToken(Constants.CORPID, Constants.SECRET).getToken();
		/**
		 * 发送客服消息（文本消息）
		 */
		// 组装文本客服消息
		String jsonTextMsg = makeTextCustomMessage("oEdzejiHCDqafJbz4WNJtWTMbDcE", "客服消息");
		// 发送客服消息
	...
	public static boolean sendCustomMessage(String accessToken, String jsonMsg) {
		...
		// 发送客服消息
		JSONObject jsonObject = HttpRequestUtil.httpRequest(requestUrl, "POST", jsonMsg);
